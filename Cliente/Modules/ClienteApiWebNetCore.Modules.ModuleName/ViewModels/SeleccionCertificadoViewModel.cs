...
{
    public class SeleccionCertificadoViewModel : RegionViewModelBase
    {
        ...
        public SeleccionCertificadoViewModel(IRegionManager regionManager,IServicioSesion servicioSesion) :
            base(regionManager)
        {
