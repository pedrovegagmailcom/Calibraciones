...
{
    public class BusquedaCertificadosViewModel : RegionViewModelBase
    {
        ...
        public BusquedaCertificadosViewModel(IRegionManager regionManager,IServicioSesion servicioSesion) :
            base(regionManager)
        {
